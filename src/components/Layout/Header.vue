<template>
    <div class="alert">
        <el-alert :closable="false" title="with description" type="success" description="This is a description." />
    </div>
    ...
    <div class="header-avatar">
        ...
        <el-dropdown>
            <div class="rob_status" v-loading.fullscreen.lock="socket.g_loading" element-loading-text="请打开服务，加载中...">
                ...
                <img :src="bot.botInfo.avatarUrl" v-if="bot.botInfo.avatarUrl" alt="">
            </div>
            <template #dropdown>
                <el-dropdown-menu>
